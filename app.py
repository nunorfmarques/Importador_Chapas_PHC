...
DB_LASER = {
    ...
    "S275JR": {
    2.0: ("11041095019", "CHAPA LISA ESP. 2,00MM S275 JR"),
    2.5: ("11041095020", "CHAPA LISA ESP. 2,50MM S275 JR"),
    3.0: ("11041095021", "CHAPA LISA ESP. 3,00MM S275 JR"),
    4.0: ("11041095022", "CHAPA LISA ESP. 4,00MM S275 JR"),
    5.0: ("11041095023", "CHAPA LISA ESP. 5,00MM S275 JR"),
    6.0: ("11041095024", "CHAPA LISA ESP. 6,00MM S275 JR"),
    8.0: ("11041095025", "CHAPA LISA ESP. 8,00MM S275 JR"),
    10.0: ("11041012010", "CHAPA LISA ESP. 10,00MM S275 JR"),
    12.0: ("11041095026", "CHAPA LISA ESP. 12,00MM S275 JR"),
    15.0: ("11041095027", "CHAPA LISA ESP. 15,00MM S275 JR"),
    16.0: ("11041095028", "CHAPA LISA ESP. 16,00MM S275 JR"),
    18.0: ("11041095029", "CHAPA LISA ESP. 18,00MM S275 JR"),
    20.0: ("11041095030", "CHAPA LISA ESP. 20,00MM S275 JR"),
    25.0: ("11041095031", "CHAPA LISA ESP. 25,00MM S275 JR"),
    30.0: ("11041095032", "CHAPA LISA ESP. 30,00MM S275 JR"),
    40.0: ("11041095033", "CHAPA LISA ESP. 40,00MM S275 JR"),
    50.0: ("11041095034", "CHAPA LISA ESP. 50,00MM S275 JR"),
},    
  
    "GALVANIZADO": {
                    1.5: ("11041095039", "CHAPA GALVANIZADA ESP. 1,50MM"),
                    2.0: ("11041095040", "CHAPA GALVANIZADA ESP. 2,00MM"),
                    3.0: ("11041095041", "CHAPA GALVANIZADA ESP. 3,00MM")
                   },
